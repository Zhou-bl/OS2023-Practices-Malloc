...
#define SET_PREV(bp, val) PUT((char *)(bp),         (val) == 0? 0 : ((long)val - (long)(heap_listp)))
#define SET_NEXT(bp, val) PUT((char *)(bp) + WSIZE, (val) == 0? 0 : ((long)val - (long)(heap_listp)))
#define GET_PREV(bp) (GET((char *)(bp))         == 0? NULL : (int *)((long)(GET((char *)(bp)))         + (long)(heap_listp)))
#define GET_NEXT(bp) (GET((char *)(bp) + WSIZE) == 0? NULL : (int *)((long)(GET((char *)(bp) + WSIZE)) + (long)(heap_listp)))
